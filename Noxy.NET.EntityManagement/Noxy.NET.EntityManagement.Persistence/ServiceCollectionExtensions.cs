...
public static class ServiceCollectionExtensions
{
    ...
    public static async Task<IHost> UsePersistence(this IHost app, Func<DataContext, bool, Task>? seedCallback = null)
    {
        ...
        {
            await seedCallback(context, Assembly.GetEntryAssembly() != null && !migrations.Any());
        }
