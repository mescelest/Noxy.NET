...
public class TextSeed(ModelBuilder builder, TableSchema refSchema) : BaseSeed(builder, refSchema)
{
    public void Apply()
    {
        ...
        HasSchemaParameterText("019789de-e449-71aa-ab1d-0e7af6463e30", TextConstants.LabelFormInputID);
        HasSchemaParameterText("01978a17-7901-7131-8b48-f882aa64e37a", TextConstants.LabelFormCodeSnippet);
        HasSchemaParameterText("01978a17-7901-7131-8b48-ff6a41005bb3", TextConstants.LabelFormDefaultValue);
        HasSchemaParameterText("01978a17-7901-7131-8b49-005b042a1608", TextConstants.LabelFormIsApprovalRequired);
        HasSchemaParameterText("01978a17-7901-7131-8b49-07a43e807dfd", TextConstants.LabelFormIsAsynchronous);
        HasSchemaParameterText("01978a1f-f0a2-731f-b17d-0991eba49899", TextConstants.LabelFormIsRepeatable);
        HasSchemaParameterText("01978a1f-f0a2-731f-b17d-0e2bbf4c0700", TextConstants.LabelFormAttributeType);
        HasSchemaParameterText("01978a1f-f0a2-731f-b17d-12579bcc7198", TextConstants.LabelFormTextParameterType);
        HasSchemaParameterText("01979d14-54ad-72f9-b5d8-a291a3ca06d4", TextConstants.LabelFormDynamicValueTypeList);
        ...
        HasSchemaParameterText("019799a3-a72f-725a-b4f6-c9599b28ac9c", TextConstants.LabelFormDynamicValueCode);
        HasSchemaParameterText("019799a3-a72f-725a-b4f6-cd308b80c164", TextConstants.LabelFormDynamicValueStyleParameter);
        HasSchemaParameterText("019799a3-a72f-725a-b4f6-d3344af0a274", TextConstants.LabelFormDynamicValueSystemParameter);
        HasSchemaParameterText("019799a3-a72f-725a-b4f6-d6b06a4f6d1b", TextConstants.LabelFormDynamicValueTextParameter);
        ...
        HasDataParameterText("019789f9-2601-72ac-ad27-ed762c6df40e", TextConstants.LabelFormInputID, "Input type");
        HasDataParameterText("01978a17-7901-7131-8b49-0a2832bb83bd", TextConstants.LabelFormCodeSnippet, "Value");
        HasDataParameterText("01978a17-7901-7131-8b49-0cb8c0a70a25", TextConstants.LabelFormDefaultValue, "Default value");
        HasDataParameterText("01978a17-7901-7131-8b49-1200bad01c81", TextConstants.LabelFormIsApprovalRequired, "Is approval required?");
        HasDataParameterText("01978a17-7901-7131-8b49-179f268688f2", TextConstants.LabelFormIsAsynchronous, "Is asynchronous?");
        HasDataParameterText("01978a1f-f0a2-731f-b17d-1981b375a5db", TextConstants.LabelFormIsRepeatable, "Is repeatable?");
        HasDataParameterText("01978a1f-f0a2-731f-b17d-1e57e7540e08", TextConstants.LabelFormAttributeType, "Attribute type");
        HasDataParameterText("01978a1f-f0a2-731f-b17d-2174a6ecd4fe", TextConstants.LabelFormTextParameterType, "Text parameter type");
        HasDataParameterText("01979d14-54ad-72f9-b5d8-aa11a0e1ce60", TextConstants.LabelFormDynamicValueTypeList, "Choose dynamic value type");
        ...
        HasDataParameterText("019799a4-1a2b-7368-9b33-809a8b75e571", TextConstants.LabelFormDynamicValueCode, "Code");
        HasDataParameterText("019799a4-1a2b-7368-9b33-86038825b246", TextConstants.LabelFormDynamicValueStyleParameter, "Style parameter");
        HasDataParameterText("019799a4-1a2b-7368-9b33-8bd3f0f5e948", TextConstants.LabelFormDynamicValueSystemParameter, "System parameter");
        HasDataParameterText("019799a4-1a2b-7368-9b33-8c2e6b4a0b6d", TextConstants.LabelFormDynamicValueTextParameter, "Text parameter");
        ...
        HasSchemaParameterText("019789fc-3929-75a9-99e9-0c9241c61162", TextConstants.HelpFormInputID);
        HasSchemaParameterText("01978a17-b7b1-772f-a129-4ce642008489", TextConstants.HelpFormCodeSnippet);
        HasSchemaParameterText("01978a17-b7b1-772f-a129-52ee6b9269cd", TextConstants.HelpFormDefaultValue);
        HasSchemaParameterText("01978a17-b7b1-772f-a129-543b087e1606", TextConstants.HelpFormIsApprovalRequired);
        HasSchemaParameterText("01978a17-b7b1-772f-a129-5bbae750bee1", TextConstants.HelpFormIsAsynchronous);
        HasSchemaParameterText("01978a20-9692-72ff-be7d-9cb3d3d46359", TextConstants.HelpFormIsRepeatable);
        HasSchemaParameterText("01978a20-9692-72ff-be7d-a3b72d338572", TextConstants.HelpFormAttributeType);
        HasSchemaParameterText("01979d14-54ad-72f9-b5d8-b33557c5a806", TextConstants.HelpFormTextParameterType);
        HasSchemaParameterText("01979d14-54ad-72f9-b5d8-c3a68639a28a", TextConstants.HelpFormDynamicValueTypeList);
        ...
        HasSchemaParameterText("019799a6-8dc0-75af-8866-a93e37c915a8", TextConstants.HelpFormDynamicValueCode);
        HasSchemaParameterText("019799a6-8dc0-75af-8866-ad7a01af4eac", TextConstants.HelpFormDynamicValueStyleParameter);
        HasSchemaParameterText("019799a6-8dc0-75af-8866-b0be19e7dcdd", TextConstants.HelpFormDynamicValueSystemParameter);
        HasSchemaParameterText("019799a6-8dc0-75af-8866-b4f08d0df491", TextConstants.HelpFormDynamicValueTextParameter);
        ...
        HasDataParameterText("019789fc-18dc-73ee-94b6-18a6e3314ccd", TextConstants.HelpFormInputID, "The type of input this entity is related with.");
        ...
        HasDataParameterText("01978a17-b7b1-772f-a129-5fe41a2f1676", TextConstants.HelpFormCodeSnippet, "The code snippet to be run. Must return a value.");
        HasDataParameterText("01978a17-b7b1-772f-a129-6253fc96820a", TextConstants.HelpFormDefaultValue, "The default value that will be used for this entity type.");
        ...
        HasDataParameterText("01978a17-b7b1-772f-a129-68c0836a0759", TextConstants.HelpFormIsAsynchronous, "Determines if the method will be run as asynchronous code.");
        HasDataParameterText("01978a20-9692-72ff-be7d-ac500344bf4b", TextConstants.HelpFormIsRepeatable, "Determines if this step can be completed with multiple results.");
        HasDataParameterText("01978a20-9692-72ff-be7d-b08279f62f4a", TextConstants.HelpFormAttributeType, "The type of attribute.");
        HasDataParameterText("01978a20-9692-72ff-be7d-b59a17facafb", TextConstants.HelpFormTextParameterType, "The type of text parameter.");
        HasDataParameterText("01979d14-54ad-72f9-b5d8-b830dc26f9f4", TextConstants.HelpFormDynamicValueTypeList, "");
        HasDataParameterText("01979d14-54ad-72f9-b5d8-bf20682e54af", TextConstants.HelpFormPropertyTypeList, "");
        HasDataParameterText("01978a20-9692-72ff-be7d-ba24274b04c3", TextConstants.HelpFormIsValueList, "Determines if this input attribute can be configured with a list of values.");
        ...
        HasDataParameterText("019799a6-6b05-7029-b9a7-40860609aed2", TextConstants.HelpFormDynamicValueCode, "Represents a dynamic code value.");
        HasDataParameterText("019799a6-6b05-7029-b9a7-473fbbc23ec3", TextConstants.HelpFormDynamicValueStyleParameter, "Represents a dynamic style parameter value.");
        HasDataParameterText("019799a6-6b05-7029-b9a7-48183a3903a4", TextConstants.HelpFormDynamicValueSystemParameter, "Represents a dynamic system parameter value.");
        HasDataParameterText("019799a6-6b05-7029-b9a7-4c3fb79cf9d1", TextConstants.HelpFormDynamicValueTextParameter, "Represents a dynamic text parameter value.");
