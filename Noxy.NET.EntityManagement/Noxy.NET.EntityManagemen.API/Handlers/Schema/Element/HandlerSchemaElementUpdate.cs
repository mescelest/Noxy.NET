...
public class HandlerSchemaElementUpdate(IUnitOfWorkFactory serviceUoWFactory) : ICommandHandler<CommandSchemaElementUpdate, ResponseSchemaElementUpdate>
{
    public async ValueTask<ResponseSchemaElementUpdate> Handle(CommandSchemaElementUpdate request, CancellationToken cancellationToken)
    {
