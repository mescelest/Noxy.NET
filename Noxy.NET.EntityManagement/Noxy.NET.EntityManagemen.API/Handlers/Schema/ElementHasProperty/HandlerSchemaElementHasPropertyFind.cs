...
public class HandlerSchemaElementHasPropertyFind(IUnitOfWorkFactory serviceUoWFactory) : IRequestHandler<QuerySchemaElementHasPropertyFind, ResponseSchemaElementHasPropertyFind>
{
    public async Task<ResponseSchemaElementHasPropertyFind> Handle(QuerySchemaElementHasPropertyFind request, CancellationToken cancellationToken)
    {
