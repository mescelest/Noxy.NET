...
public class HandlerSchemaElementHasPropertyCreate(IUnitOfWorkFactory serviceUoWFactory) : IRequestHandler<CommandSchemaElementHasPropertyCreate, ResponseSchemaElementHasPropertyCreate>
{
    public async Task<ResponseSchemaElementHasPropertyCreate> Handle(CommandSchemaElementHasPropertyCreate request, CancellationToken cancellationToken)
    {
