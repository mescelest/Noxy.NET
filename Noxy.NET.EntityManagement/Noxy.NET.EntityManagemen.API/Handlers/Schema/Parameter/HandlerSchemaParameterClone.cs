...
public class HandlerSchemaParameterClone(IUnitOfWorkFactory serviceUoWFactory) : ICommandHandler<CommandSchemaParameterClone, ResponseSchemaParameterClone>
{
    public async ValueTask<ResponseSchemaParameterClone> Handle(CommandSchemaParameterClone request, CancellationToken cancellationToken)
    {
