...
public class HandlerSchemaParameterStyleUpdate(IUnitOfWorkFactory serviceUoWFactory) : ICommandHandler<CommandSchemaParameterStyleUpdate, ResponseSchemaParameterStyleUpdate>
{
    public async ValueTask<ResponseSchemaParameterStyleUpdate> Handle(CommandSchemaParameterStyleUpdate request, CancellationToken cancellationToken)
    {
