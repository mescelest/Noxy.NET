...
public class HandlerSchemaPropertyImageCreate(IUnitOfWorkFactory serviceUoWFactory) : IRequestHandler<CommandSchemaPropertyImageCreate, ResponseSchemaPropertyImageCreate>
{
    public async Task<ResponseSchemaPropertyImageCreate> Handle(CommandSchemaPropertyImageCreate request, CancellationToken cancellationToken)
    {
