...
public class HandlerSchemaPropertyBooleanUpdate(IUnitOfWorkFactory serviceUoWFactory) : IRequestHandler<CommandSchemaPropertyBooleanUpdate, ResponseSchemaPropertyBooleanUpdate>
{
    public async Task<ResponseSchemaPropertyBooleanUpdate> Handle(CommandSchemaPropertyBooleanUpdate request, CancellationToken cancellationToken)
    {
