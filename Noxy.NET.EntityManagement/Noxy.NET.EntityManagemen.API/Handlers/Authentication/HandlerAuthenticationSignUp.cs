...
public class HandlerAuthenticationSignUp(IUnitOfWorkFactory serviceUoWFactory, IJWTService serviceJWT) : ICommandHandler<CommandAuthenticationSignUp, ResponseAuthenticationSignUp>
{
    public async ValueTask<ResponseAuthenticationSignUp> Handle(CommandAuthenticationSignUp request, CancellationToken cancellationToken)
    {
