        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescriptionDynamicID = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    ActiveDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    IsActiveDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    TimeCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TimeUpdated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Note = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableSchemaAction_TableSchemaDynamicValueCode_ActiveDynamicID",
                        column: x => x.ActiveDynamicID,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    DefaultValueDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    TimeCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TimeUpdated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Note = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyBoolean_TableSchemaDynamicValueCode_DefaultValueDynamicID",
                        column: x => x.DefaultValueDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    MinDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    MaxDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    DefaultValueDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    TimeCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TimeUpdated = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Name = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyDateTime_TableSchemaDynamicValueCode_DefaultValueDynamicID",
                        column: x => x.DefaultValueDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyDateTime_TableSchemaDynamicValueCode_MaxDynamicID",
                        column: x => x.MaxDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyDateTime_TableSchemaDynamicValueCode_MinDynamicID",
                        column: x => x.MinDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyString_TableSchemaDynamicValueCode_DefaultValueDynamicID",
                        column: x => x.DefaultValueDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyString_TableSchemaDynamicValueCode_MaxDynamicID",
                        column: x => x.MaxDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_TableSchemaPropertyString_TableSchemaDynamicValueCode_MinDynamicID",
                        column: x => x.MinDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    IsActiveDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    ValidDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                    IsValidDynamicID = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableSchemaActionInput_TableSchemaDynamicValueCode_ActiveDynamicID",
                        column: x => x.ActiveDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_TableSchemaActionInput_TableSchemaDynamicValueCode_ValidDynamicID",
                        column: x => x.ValidDynamicID,
                        principalTable: "TableSchemaDynamicValueCode",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "TableJunctionSchemaElementHasAction",
                columns: table => new
                {
                    ID = table.Column<Guid>(type: "TEXT", nullable: false),
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TableJunctionSchemaElementHasAction", x => x.ID);
                    table.ForeignKey(
                        name: "FK_TableJunctionSchemaElementHasAction_TableSchemaAction_RelationID",
                        column: x => x.RelationID,
                        principalTable: "TableSchemaAction",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TableJunctionSchemaElementHasAction_TableSchemaElement_EntityID",
                        column: x => x.EntityID,
                        principalTable: "TableSchemaElement",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "Name", "Note", "Order", "SchemaID", "SchemaIdentifier", "TimeCreated", "TimeUpdated" },
                values: new object[,]
                {
                    { new Guid("01974e8c-ecb8-75ab-9070-f0fed39b9c54"), "Checkbox", "The base checkbox input type.", 1, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputCheckbox", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("01974e8c-ecb8-75ab-9070-f625218aed76"), "Date input", "The base date input type.", 2, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputDate", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("01974e8c-ecb8-75ab-9070-f8a855e17dda"), "Text input", "The base text input type.", 7, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputText", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("019765f7-2847-757d-8d6f-e48dbec5bbeb"), "Decimal input", "The base decimal input type.", 3, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputDecimal", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("019765f7-2847-757d-8d6f-ea72d6453f86"), "Integer input", "The base integer input type.", 4, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputInteger", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("019765f7-2847-757d-8d6f-ec49fff67113"), "Password input", "The base password input type.", 5, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputPassword", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null },
                    { new Guid("019765f7-2847-757d-8d6f-ec49fff67fa1"), "Single choice input", "The base single choice input type.", 6, new Guid("01974e8c-ecb8-75ab-9070-ef902ff370a7"), "ActionInputSingleChoice", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableJunctionSchemaElementHasAction_EntityID_RelationID",
                table: "TableJunctionSchemaElementHasAction",
                columns: new[] { "EntityID", "RelationID" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TableJunctionSchemaElementHasAction_RelationID",
                table: "TableJunctionSchemaElementHasAction",
                column: "RelationID");

            migrationBuilder.CreateIndex(
                name: "IX_TableJunctionSchemaElementHasAction_TimeCreated",
                table: "TableJunctionSchemaElementHasAction",
                column: "TimeCreated");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaAction_ActiveDynamicID",
                table: "TableSchemaAction",
                column: "ActiveDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaAction_DescriptionDynamicID",
                table: "TableSchemaAction",
                column: "DescriptionDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionInput_ActiveDynamicID",
                table: "TableSchemaActionInput",
                column: "ActiveDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionInput_DescriptionDynamicID",
                table: "TableSchemaActionInput",
                column: "DescriptionDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionInput_TitleDynamicID",
                table: "TableSchemaActionInput",
                column: "TitleDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionInput_ValidDynamicID",
                table: "TableSchemaActionInput",
                column: "ValidDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionStep_DescriptionDynamicID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaActionStep_TitleDynamicID",
                table: "TableSchemaActionStep",
                column: "TitleDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaContext_DescriptionDynamicID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaContext_TitleDynamicID",
                table: "TableSchemaContext",
                column: "TitleDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaElement_DescriptionDynamicID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaElement_TitleDynamicID",
                table: "TableSchemaElement",
                column: "TitleDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyBoolean_DefaultValueDynamicID",
                table: "TableSchemaPropertyBoolean",
                column: "DefaultValueDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyBoolean_DescriptionDynamicID",
                table: "TableSchemaPropertyBoolean",
                column: "DescriptionDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyBoolean_TitleDynamicID",
                table: "TableSchemaPropertyBoolean",
                column: "TitleDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyCollection_DescriptionDynamicID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyCollection_TitleDynamicID",
                table: "TableSchemaPropertyCollection",
                column: "TitleDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyDateTime_DefaultValueDynamicID",
                table: "TableSchemaPropertyDateTime",
                column: "DefaultValueDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyDateTime_DescriptionDynamicID",
                table: "TableSchemaPropertyDateTime",
                column: "DescriptionDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyDateTime_MaxDynamicID",
                table: "TableSchemaPropertyDateTime",
                column: "MaxDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyDateTime_MinDynamicID",
                table: "TableSchemaPropertyDateTime",
                column: "MinDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyDateTime_TitleDynamicID",
                table: "TableSchemaPropertyDateTime",
                column: "TitleDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyString_DefaultValueDynamicID",
                table: "TableSchemaPropertyString",
                column: "DefaultValueDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyString_DescriptionDynamicID",
                table: "TableSchemaPropertyString",
                column: "DescriptionDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyString_MaxDynamicID",
                table: "TableSchemaPropertyString",
                column: "MaxDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyString_MinDynamicID",
                table: "TableSchemaPropertyString",
                column: "MinDynamicID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyString_TitleDynamicID",
                table: "TableSchemaPropertyString",
                column: "TitleDynamicID");

            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyTable_DescriptionDynamicID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSchemaPropertyTable_TitleDynamicID",
                table: "TableSchemaPropertyTable",
                column: "TitleDynamicID");
