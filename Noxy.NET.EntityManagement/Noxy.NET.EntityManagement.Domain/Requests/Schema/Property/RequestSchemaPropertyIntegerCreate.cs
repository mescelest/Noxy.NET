...
public class RequestSchemaPropertyIntegerCreate : BaseRequestPost<ResponseSchemaPropertyIntegerCreate>
{
    ...
    [DisplayName(ParameterTextConstants.LabelFormIsUnsigned)]
    [Description(ParameterTextConstants.HelpFormIsUnsigned)]
