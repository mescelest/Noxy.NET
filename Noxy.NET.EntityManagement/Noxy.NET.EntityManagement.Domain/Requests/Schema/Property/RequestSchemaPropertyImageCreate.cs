...
public class RequestSchemaPropertyImageCreate : BaseRequestPost<ResponseSchemaPropertyImageCreate>
{
    public override string APIEndpoint => "Schema/Parameter/Image";
