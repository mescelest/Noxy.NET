...
public class RequestSchemaPropertyStringUpdate : BaseRequestPost<ResponseSchemaPropertyStringUpdate>
{
    public override string APIEndpoint => $"Schema/Parameter/String/{ID}";
