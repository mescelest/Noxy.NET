...
public class RequestSchemaPropertyDecimalUpdate : BaseRequestPost<ResponseSchemaPropertyDecimalUpdate>
{
    public override string APIEndpoint => $"Schema/Parameter/Decimal/{ID}";
