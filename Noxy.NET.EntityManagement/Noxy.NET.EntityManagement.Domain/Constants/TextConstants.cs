...
public static class TextConstants
{
    ...
    public const string HeaderFormCreateEntitySchemaElement = "Header:Form:Create:EntitySchemaElement";
    public const string HeaderFormCreateEntitySchemaParameterStyle = "Header:Form:Create:EntitySchemaParameterStyle";
    public const string HeaderFormCreateEntitySchemaParameterSystem = "Header:Form:Create:EntitySchemaParameterSystem";
    public const string HeaderFormCreateEntitySchemaParameterText = "Header:Form:Create:EntitySchemaParameterText";
    public const string HeaderFormCreateEntitySchemaPropertyBoolean = "Header:Form:Create:EntitySchemaPropertyBoolean";
    public const string HeaderFormCreateEntitySchemaPropertyCollection = "Header:Form:Create:EntitySchemaPropertyCollection";
    public const string HeaderFormCreateEntitySchemaPropertyDateTime = "Header:Form:Create:EntitySchemaPropertyDateTime";
    public const string HeaderFormCreateEntitySchemaPropertyDecimal = "Header:Form:Create:EntitySchemaPropertyDecimal";
    public const string HeaderFormCreateEntitySchemaPropertyImage = "Header:Form:Create:EntitySchemaPropertyImage";
    public const string HeaderFormCreateEntitySchemaPropertyInteger = "Header:Form:Create:EntitySchemaPropertyInteger";
    public const string HeaderFormCreateEntitySchemaPropertyString = "Header:Form:Create:EntitySchemaPropertyString";
    public const string HeaderFormCreateEntitySchemaPropertyTable = "Header:Form:Create:EntitySchemaPropertyTable";

    public const string HeaderFormUpdateEntitySchema = "Header:Form:Update:EntitySchema";
    public const string HeaderFormUpdateEntitySchemaContext = "Header:Form:Update:EntitySchemaContext";
    public const string HeaderFormUpdateEntitySchemaElement = "Header:Form:Update:EntitySchemaElement";
    public const string HeaderFormUpdateEntitySchemaParameterStyle = "Header:Form:Update:EntitySchemaParameterStyle";
    public const string HeaderFormUpdateEntitySchemaParameterSystem = "Header:Form:Update:EntitySchemaParameterSystem";
    public const string HeaderFormUpdateEntitySchemaParameterText = "Header:Form:Update:EntitySchemaParameterText";
    public const string HeaderFormUpdateEntitySchemaPropertyBoolean = "Header:Form:Update:EntitySchemaPropertyBoolean";
    public const string HeaderFormUpdateEntitySchemaPropertyCollection = "Header:Form:Update:EntitySchemaPropertyCollection";
    public const string HeaderFormUpdateEntitySchemaPropertyDateTime = "Header:Form:Update:EntitySchemaPropertyDateTime";
    public const string HeaderFormUpdateEntitySchemaPropertyDecimal = "Header:Form:Update:EntitySchemaPropertyDecimal";
    public const string HeaderFormUpdateEntitySchemaPropertyImage = "Header:Form:Update:EntitySchemaPropertyImage";
    public const string HeaderFormUpdateEntitySchemaPropertyInteger = "Header:Form:Update:EntitySchemaPropertyInteger";
    public const string HeaderFormUpdateEntitySchemaPropertyString = "Header:Form:Update:EntitySchemaPropertyString";
    public const string HeaderFormUpdateEntitySchemaPropertyTable = "Header:Form:Update:EntitySchemaPropertyTable";
}
